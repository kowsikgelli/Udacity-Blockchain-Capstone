...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != _tokenOwner[tokenId],"cannot send token to same address");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == _tokenOwner[tokenId] || isApprovedForAll(_tokenOwner[tokenId],msg.sender),"caller dont have access");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(to != address(0),"destination address is invalid");
        // TODO: clear approval
...
contract customERC721Token is ERC721Metadata("RealEstate","RET","https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/"){
